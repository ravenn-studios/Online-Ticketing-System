        ...
        <div class="modal-content">
            ...
            <form role="form" id="formCreateCustomPage">
                            ...
                            <div class="pl-lg-4 pt-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 all-page-conditions-block">
                                        ...
                                        {{-- <div class="row all condition-blocks condition-block1" data-row="1" data-operator="AND"> --}}
                                        <div class="row">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm float-right add-row-condition all" data-target-class="all-page-conditions-block" data-is-create="true" data-action="all">
                                    ...
                                    <div class="col-lg-6 any-page-conditions-block">
                                        ...
                                        {{-- <div class="row any condition-blocks condition-block1" data-row="1" data-operator="OR"> --}}
                                        <div class="row">
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm float-right add-row-condition any" data-target-class="any-page-conditions-block" data-is-create="true" data-action="any">
                                            <i class="fas fa-plus"></i> ADD CONDITION</button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-create-page-conditions">Create</button>
                </div>
