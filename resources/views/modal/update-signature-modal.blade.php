<div class="modal fade" id="modalUpdateSignature" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">

            <form role="form" id="formUpdateSignature">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <div class="pl-lg-4 pt-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="updateSignatureContentEditor" rows="6"></textarea>
                                </div>
