                    ...
                    <tr>
                      <td align="center">
                          <table class="insider" style="width: 100%; padding: 0px 20px;">
                            <tbody>
                              <tr align="left">
                                <td style="font-family: 'Raleway', sans-serif; font-size:23px; color:#2a3b4c; line-height:30px; font-weight: bold;">{{ $emailNotification->title }}</td>
                              </tr>
                              <tr>
                                <td height="5"></td>
                              </tr>
                              <tr>
                                <td style="font-family: 'Lato', sans-serif; font-size:14px; color:#7f8c8d; line-height:24px; font-weight: 300;"> {{ $emailNotification->description }} <a href="{{ $ticketsViewUrl }}" target="_blank" style="text-decoration: none;">View Tickets</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
