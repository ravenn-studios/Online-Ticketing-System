			...
			<div class="header-body text-center mb-7">
				<div class="row justify-content-center">
					<div class="col-xl-5 col-lg-6 col-md-8 px-5">
						<h1 class="text-white">Frankies Online Ticketing Application</h1>
						<p class="text-lead text-white">Welcome!</p>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="card-header bg-transparent pb-5">
						...
						<div class="btn-wrapper text-center">
							<a href="#" class="btn btn-neutral btn-icon">
								<span class="btn-inner--icon"><img src="{{ asset('images/icons/common/github.svg') }}"></span>
								<span class="btn-inner--text">Github</span>
							</a>
							<a href="#" class="btn btn-neutral btn-icon">
								<span class="btn-inner--icon"><img src="{{ asset('images/icons/common/google.svg') }}"></span>
